...
# get the name of the file to work with.
    xmlFile = str(input("Please enter the output filename: "))
...
def post_data():
 ...
 # get the name of the file to work with.
    xmlFile = str(input("Please enter the input filename: "))
    # open the aforementioned file for reading.
    xmlData = open(xmlFile, 'r')
    # so many questions so little time! URL please?
    url = str(input("Please enter the authentication URL: "))
    # more questions!
    username = str(input("Please enter the username: "))
    # secure way to get the password.
    passwd = getpass('Please enter the password: '    )
...
def main():
    print("This program was created as a way to manipulate skills")
